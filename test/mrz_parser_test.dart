...
void main() {
  final expectResult = ({final List<String?>? input, final MRZResult? expectedOutput,final bool validate = true}) =>
      expect(MRZParser.parse(input,validate: validate), expectedOutput);
